...
void sys_print_color(const char* msg) {
    core_print(msg);
}
...
void sys_int_ignore(void) { sys_print_color(
        "RESERVED: 32-255 |0x1F-0xFF| **Not yet populated with handlers\n");
    while (1);
}
